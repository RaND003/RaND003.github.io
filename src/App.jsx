...
export default function App() {
  ...
  const users = [
   {
      name: "ميس",
      message: "ميسوو، عيدك مبارك يا جميلة ، بتنمالك كل التوفيق بحياتك وبإني أكون صاحبة ممكن تساعدك زي ما دايماً بتساعديني، بحبك كثير كثير كثير، استمتعي بيومكᓚᘏᗢ",      photo: "/star.png",
      secondImage: "/lib.png",
      thirdImage: "/arr4.png",
      bg: "#6185E0",
